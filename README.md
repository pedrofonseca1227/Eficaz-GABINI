...
<p>Este projeto não tem dependências externas porém é recomendado ter um ambiente de desinvolvimento local para testes, já que é feito apenas em HTML e CSS. Para visualizar o projeto, basta apenas um navegador.</p>
